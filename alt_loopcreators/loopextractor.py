...
def run_algorithm(audio_file, n_templates=[0,0,0], output_savename="extracted_loop", beats_num=16):
    ...
    downbeat_times = get_downbeats(signal_mono, beats_num)
    ...
    for ith_loop in range(n_loops):
        ...
        sf.write("{0}_{1}.wav".format(output_savename,ith_loop), ith_loop_signal, fs)

def get_downbeats(signal, beats_num):
    ...
    proc = madmom.features.downbeats.DBNDownBeatTrackingProcessor(beats_per_bar=[3, beats_num], fps=100)
...
if __name__ == "__main__":
    ...
    run_algorithm("/Users/ryohasegawa/Downloads/Dragon_Night.wav", n_templates=[0,0,0], output_savename="dragon_night")
